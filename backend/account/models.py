...
class StripeModel(models.Model):
    ...
    card_id = models.TextField(null=True, blank=True)  # Removed max_length for TextField
    ...
    address_zip = models.CharField(max_length=10, validators=[RegexValidator(r'^\d{0,9}$')], null=True, blank=True)  
...
class BillingAddress(models.Model):
    ...
    pin_code = models.CharField(max_length=10, validators=[RegexValidator(r'^\d{0,9}$')], null=False, blank=False) 
    house_no = models.CharField(max_length=300, null=False, blank=False)
    landmark = models.CharField(max_length=255, null=False, blank=False)
...
class OrderModel(models.Model):
    ...
    ordered_item = models.CharField(max_length=255, null=True, blank=True, default="Not Set")
    ...
    delivered_at = models.CharField(max_length=255, null=True, blank=True)
